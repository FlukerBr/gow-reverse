...
typedef UINT32 goPlayer__vtable;

typedef struct goPlayerControls {
...
typedef struct StateData__1_15931 {
    VUMat4 playerMatrix;
...
extern void goPlayer_AcquireAllPickups(goPlayer *, int maxOutBladesAndMagic);
...
extern UINT32 goPlayer_GetTarget(goPlayer *, int);
extern void goPlayer_FindAllTargets(goPlayer *, VUVec4,float,uint,goCreature *);
extern UINT32 goPlayer_FindAllTargetsAroundPlayer(goPlayer *, float,uint,goCreature *);
