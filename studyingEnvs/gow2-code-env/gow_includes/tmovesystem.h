...
extern uint tMoveSystem_sm_fSlowdownTimeScale;
extern uint tMoveSystem_sm_fSlowdownDuration;
extern uint tMoveSystem_sm_tMoveSystemMultiPool;
extern uint tMoveSystem_sm_pUpdateScript;
