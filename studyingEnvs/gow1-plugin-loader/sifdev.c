...
int _sceCallCode(const char *param_1,int param_2)
{
    ...
    *(char*)&DAT_32934C = *param_1;
    iVar3 = 0;
    if ((char)DAT_32934C != '\0')
    {
        for (iVar3 = 1;
            (iVar3 < 0x400 &&
            (cVar1 = param_1[iVar3], *(char *)((int)&DAT_32934C + iVar3) = cVar1, cVar1 != '\0'));
            iVar3 = iVar3 + 1) {
        }
    }
    if (iVar3 == 0x400)
...
size_t sceLseek(int fd,size_t offset,int whence)
{
    ...
    {
        DAT_32934C = iob->mode;
        DAT_329358 = ((uint)iob - (uint)&_iob) >> 4;
        sema.max_count = 1;
        sema.init_count = 0;
        sema.option = 0;
        DAT_329350 = offset;
...
int sceGetstat(const char *name, sce_stat *buf)
{
    ...
    ((char*)&DAT_329350)[0] = name[0];
    iVar2 = 0;
    cVar1 = (char)DAT_329350;
    while (iVar3 = iVar2, cVar1 != '\0') {
        iVar3 = iVar2 + 1;
        if (0x3ff < iVar3) break;
        cVar1 = name[iVar3];
        *(char *)((int)&DAT_329350 + iVar2 + 1) = cVar1;
        iVar2 = iVar3;
    }
    if (iVar3 == 0x400)
    {
